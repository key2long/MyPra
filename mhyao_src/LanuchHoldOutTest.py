...
def one_hold_out_experiment(hold_out_id: int,
    ...
    try:
        ...
        poor_relation_set = train_valid_experiment.train_this_hold_out(if_save_model=True, hold_out_id=hold_out_id)
...
if __name__ == "__main__":
    ...
    for name in graph_names:
        ...
        for hold_out_k in range(split_k):
            test_results_list.append(process_pool.apply_async(func=one_hold_out_experiment,
                                                              args=(hold_out_k,
                                                                    processed_path,
                                                                    name,
                                                                    hold_out_fold,
